...
namespace DeviceManagment.Views
{
    ...
    /// </summary>
    public partial class CustomPairingView : UserControl
    {
          ...
          DevicePairingRequestedEventArgs args)
      {
         switch (args.PairingKind)
         {
            ...
            case DevicePairingKinds.DisplayPin:
               ...
               await rootPage.Dispatcher.BeginInvoke((Action) (() =>
               {
                  ShowPairingPanel(
            ...
            case DevicePairingKinds.ProvidePin:
               ...
               await rootPage.Dispatcher.BeginInvoke((Action) (async () =>
               {
