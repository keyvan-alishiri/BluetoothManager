...
namespace DeviceManagment
{
    ...
    public class DeviceInformationDisplay : INotifyPropertyChanged
    {
        ...
        // string str = string.Concat(System.IO.Path.GetDirectoryName(System.Windows.Forms.Application.ExecutablePath), "\\Config\\Assets\\{0}_{1}bar.png");


        // string imageFileName = string.Format(str, imageFileNamePrefix, signal);
        // WiFiImage = new System.Windows.Media.Imaging.BitmapImage(new Uri(imageFileName));


        // glyphBitmapImage.UriSource = new Uri(@"/sampleImages/cherries_larger.jpg", UriKind.RelativeOrAbsolute);
        // glyphBitmapImage.EndInit();
        // // Set the image source.
         
        //// await glyphBitmapImage.StreamSource(deviceThumbnail);
